...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.purplegraphite.packages_info_android.PackagesInfoAndroidPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin packages_info_android, com.purplegraphite.packages_info_android.PackagesInfoAndroidPlugin", e);
    }
    try {
